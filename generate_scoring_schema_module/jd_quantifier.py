...
def gen_and_log_schema_from_jd(jd_path: str, scoring_scale_min: int, scoring_scale_max: int,
                              google_api_key: str, model: str, prompt_template: str,
                              cleanlab_tlm_api_key: str, athina_api_key: str):
    """
    ...
    Args:
        ...
        cleanlab_tlm_api_key (str): API key for Cleanlab TLM.
